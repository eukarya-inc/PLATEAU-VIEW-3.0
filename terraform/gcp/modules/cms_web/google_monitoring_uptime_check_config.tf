resource "google_monitoring_uptime_check_config" "cms_web" {
  project = data.google_project.project.project_id

  display_name = "Re:Earth CMS Web Cloud Run Uptime Check (${var.region})"
  ...
  monitored_resource {
    ...
    labels = {
      ...
      project_id : google_cloud_run_v2_service.cms_web.project
