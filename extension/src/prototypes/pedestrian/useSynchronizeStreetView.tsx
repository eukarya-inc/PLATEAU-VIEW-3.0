  ...
  return useMemo(() => {
    const locationAtom = atom(
      ...
      (get, set, value: SetStateAction<Location>) => {
        ...
        // if (synchronized) {
        //   if (prevValue != null) {
        //     const prevPosition = computeCartographicToCartesian(scene, prevValue, cartesianScratch);
        ...
        //     const nextPosition = computeCartographicToCartesian(scene, nextValue, cartesianScratch);
        ...
        //   } else {
        //     computeCartographicToCartesian(scene, nextValue, scene.camera.position);
        //   }
        // }
      },
    );
