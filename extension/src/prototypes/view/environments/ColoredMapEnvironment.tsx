...
export const ColoredMapEnvironment: FC<SceneProps> = ({ tileLabels, ...props }) => {
    ...
    () => [
      {
        id: "colored_map_1",
        tile_url:
          "https://storage.googleapis.com/reearth-xyz-tiles/terrain-background/{z}/{x}/{y}.png",
        tile_type: "url",
      },
      {
        id: "colored_map_2",
        tile_url: "https://storage.googleapis.com/reearth-xyz-tiles/terrain-lines/{z}/{x}/{y}.png",
        tile_type: "url",
      },
    ],
    [],
