...
type ViewLayerModelParams<T extends LayerType> =
  ...
  T extends typeof BRIDGE_LAYER ? never : // BridgeLayerModelParams :
  ...
  T extends typeof LAND_USE_LAYER ? never : // LandUseLayerModelParams :
  T extends typeof LANDMARK_LAYER ? never : // LandmarkLayerModelParams
  T extends typeof LAND_SLIDE_RISK_LAYER ? never : // LandSlideRiskLayerModelParams :
  T extends typeof PARK_LAYER ? never : // ParkLayerModelParams
  T extends typeof RAILWAY_LAYER ? never : // RailwayLayerModelParams
  T extends typeof RIVER_FLOODING_RISK_LAYER ? never : // RiverFloodingRiskLayerModelParams :
  T extends typeof ROAD_LAYER ? never : // RoadLayerModelParams :
  ...
  T extends typeof URBAN_PLANNING_LAYER ? never :// UrbanPlanningLayerModelParams :
...
export function createViewLayer<T extends LayerType>(
  ...
  switch (params.type) {
    ...
    case BRIDGE_LAYER: return undefined // createBridgeLayer(params as BridgeLayerModelParams)
    ...
    case LAND_USE_LAYER: return undefined // createLandUseLayer(params as LandUseLayerModelParams)
    case LANDMARK_LAYER: return undefined // createLandmarkLayer(params)
    case LAND_SLIDE_RISK_LAYER: return undefined // createLandSlideRiskLayer(params as LandSlideRiskLayerModelParams)
    case PARK_LAYER: return undefined // createParkLayer(params)
    case RAILWAY_LAYER: return undefined // createRailwayLayer(params)
    case RIVER_FLOODING_RISK_LAYER: return undefined // createRiverFloodingRiskLayer(params as RiverFloodingRiskLayerModelParams)
    case ROAD_LAYER: return undefined // createRoadLayer(params as RoadLayerModelParams)
    ...
    case URBAN_PLANNING_LAYER: return undefined // createUrbanPlanningLayer(params as UrbanPlanningLayerModelParams)
